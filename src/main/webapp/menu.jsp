    ...
    <ul class="cd-accordion margin-top-lg margin-bottom-lg">
        ...
        <li class="cd-accordion__item cd-accordion__item--has-children">
            ...
            <ul class="cd-accordion__sub cd-accordion__sub--l1">
                <li class="cd-accordion__item submenu"><a class="cd-accordion__label cd-accordion__label--icon-img" href="/TadesSkate/Clientes/CadastrarClientes.jsp"><i class="fa fa-plus"></i><span>Cadastrar Cliente</span></a></li>
        ...
        <li class="cd-accordion__item cd-accordion__item--has-children">
            ...
            <ul class="cd-accordion__sub cd-accordion__sub--l2">
                <li class="cd-accordion__item submenu"><a class="cd-accordion__label cd-accordion__label--icon-img" href="/TadesSkate/Funcionarios/cadastrarFuncionario.jsp"><i class="fa fa-plus"></i><span>Cadastrar Funcionário</span></a></li>
        ...
        <li class="cd-accordion__item cd-accordion__item--has-children">
            ...
            <ul class="cd-accordion__sub cd-accordion__sub--l3">
                <li class="cd-accordion__item  submenu"><a class="cd-accordion__label cd-accordion__label--icon-img" href="/TadesSkate/Produtos/CadastrarProduto.jsp"><i class="fa fa-plus"></i><span>Cadastrar Produto</span></a></li>
        ...
        <li class="cd-accordion__item cd-accordion__item--has-children">
            ...
            <ul class="cd-accordion__sub cd-accordion__sub--l4">
                <li class="cd-accordion__item  submenu"><a class="cd-accordion__label cd-accordion__label--icon-img" href="/TadesSkate/Filiais/CadastrarFilial.jsp"><i class="fa fa-plus"></i><span>Cadastrar Filial</span></a></li>
        ...
        <li class="cd-accordion__item cd-accordion__item--has-children">
            ...
            <ul class="cd-accordion__sub cd-accordion__sub--l4">
                <li class="cd-accordion__item  submenu"><a class="cd-accordion__label cd-accordion__label--icon-img" href="/TadesSkate/Filiais/CadastrarFilial.jsp"><i class="fa fa-align-justify"></i><span>Relatório Filial</span></a></li>
