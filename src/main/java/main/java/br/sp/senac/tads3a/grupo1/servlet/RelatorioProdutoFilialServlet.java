 ...
 * @author 004039631
 */
public class RelatorioProdutoFilialServlet extends HttpServlet {
    ...
    List<Relatorio> relatorios =RelatorioDAO.getProdutosMaisVendidos(dataInicio, dataFim, f.getFk_filial_id());
